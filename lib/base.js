...
var ParamError = Class(Error, {
  constructor: function(opts) {
    this.name = opts.name;
    this.value = opts.value;
    this.message = 'Invalid path parameter ' + this.name + '=' + this.value;
  }
});
...
var QueryError = Class(Error, {
  constructor: function _QueryError(opts) {
    this.key = opts.key;
    this.value = opts.value;
    this.message = (
...
proto.uri = function(params) {
  return this.string(params) + this.queryString(params);
};

proto.query = function(params) {
  var query = {};
  this._iterQuery(params, function(key, value) {
    query[key] = value;
  });
  return query;
};

proto.queryString = function(params) {
  var query = [];
  this._iterQuery(params, function(key, value) {
    query.push(
...
proto._iterQuery = function(params, fn) {
  params = params || {};
